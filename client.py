"""
  ...
  Edited by Tom Vecchi for 2020 FarmBot thesis project

  This file contains code for controlling the FarmBot remotely via MQTT.
"""
...
class FarmbotClient(object):
  ...
  def __init__(self, device_id, token, mqtt_server):
    ...
    self.pending_uuid = None # Added this for thesis (didn't work without it)
