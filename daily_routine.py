"""
    ...
    The daily_routine function is what is run 24/7 in order to obtain imagery 
    from the FarmBot on an ongoing basis. Run this file from the command line
    in order to start the process running.
"""
...
def daily_routine(plant_file):
    ...
    for p in plants:
        ...
        p.run_segmenter(segmenter)

        p.run_classifier(classifier)
...
if __name__ == "__main__":
    ...
    daily_routine("plant_locations.txt")
